$(document).ready(function(){
    ...
    //utilize multiple animate event mehtods in the same function
    function shineLoop(){
    ...
    //sets the delayed amount of time between each reapeat
    ...
    $("#classicCars").on({
        ...
        //Tiggers the images to slide up and hide each title
    ...
    //Creates a togle effect on each FAQ question by checking
